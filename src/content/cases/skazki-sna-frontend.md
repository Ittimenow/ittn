...
featured: true
order: 80
cover: '/cases/skazki-sna-frontend/img-skazkisna-main-4x3-1.webp'
...
![Скетчи Сказки сна](/cases/skazki-sna-frontend/img-skazkisna-sketches-2.webp)
...
![Сказки сна элементы дизайна](/cases/skazki-sna-frontend/img-skazkisna-elements.webp)
	...
	<div class="case-slider-viewport">
		<div class="case-slider-track">
			<div class="case-slider-slide">
				<img src="/cases/skazki-sna-frontend/img-skazkisna-color-1.webp" alt="Эксперимент с цветовым акцентом Сказки сна" />
			</div>
			<div class="case-slider-slide">
				<img src="/cases/skazki-sna-frontend/img-skazkisna-color-2.webp" alt="Альтернативный цветовой акцент Сказки сна" />
			</div>
		</div>
	</div>
...
<section class="case-slider" data-case-slider aria-label="Интерфейсные экраны Сказки сна">
	<div class="case-slider-viewport">
		<div class="case-slider-track">
			<div class="case-slider-slide">
				<img src="/cases/skazki-sna-frontend/img-skazkisna-1.webp" alt="Экран лендинга Сказки сна" />
			</div>
			<div class="case-slider-slide">
				<img src="/cases/skazki-sna-frontend/img-skazkisna-2.webp" alt="Интерактивный блок лендинга Сказки сна" />
			</div>
			<div class="case-slider-slide">
				<img src="/cases/skazki-sna-frontend/img-skazkisna-3.webp" alt="Мобильный экран лендинга Сказки сна" />
			</div>
			<div class="case-slider-slide">
				<img src="/cases/skazki-sna-frontend/img-skazkisna-4.webp" alt="Экран видеоролика Сказки сна" />
			</div>
		</div>
	</div>
	<div class="case-slider-controls">
...
<section class="case-mobile-showcase">
	...
	<img src="/cases/skazki-sna-frontend/img-skazkisna-datapicker-2.webp" alt="Концепт выбора времени мероприятия" />
</section>
...
<div class="case-team">
	...
	<div class="case-team-card">
		<img src="/cases/skazki-sna-frontend/avatar-goga.webp" alt="Фото участника проекта" />
		<h4>Дизайнер</h4>
		<p>Гога</p>
	</div>
	<div class="case-team-card">
